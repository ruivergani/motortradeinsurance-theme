...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?> 
  ...
  <div class="w-full max-w-[1246px] mx-auto px-[15px]">
    <section class="py-[100px] max-sm:py-[30px] max-lg:py-[60px] flex justify-between items-start gap-[20px] max-md:flex-col-reverse">
      <div class="flex gap-[30px] max-sm:gap-[20px] flex-col w-full max-w-[559px] max-md:max-w-full">
        ...
        <span class="font-sans text-gray700 text-sm max-sm:text-center"><?php the_field('terms_conditions_why_us_page_car_traders_insurance') ?></span>
      </div>
  ...
  <!-- Secondary Content -->
  <div class="w-full max-w-[1246px] mx-auto px-[15px]">
    <section class="pb-[100px] max-sm:pb-[30px] max-md:pb-[40px] flex flex-row justify-between items-center gap-[20px] max-lg:flex-col max-lg:justify-center max-sm:text-center">
      <div class="w-full max-w-[520px]">
